...
/* version Windows du serveur web vite-fait
 * 'cat' sous Unix devient 'type'
 * / sous Unix devient \
 */
	...
	while(!feof(stdin)) {
		...
		if(!strcmp(tokens[0], "GET")){
			...
			if(strstr(tokens[1], "/client/decor/")){
				printf("\n");
				fflush(stdout);
				sprintf(tmp, "type sloche-data\\%s", tokens[1] + strlen("/client/decor/"));
				fprintf(log, "resp: %s\n", tmp);
				system(tmp);
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/client/popup.html")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\popup.html");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\index.html");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/splahtml.gif")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\splahtml.gif");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs.txt")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\pouvoirs.txt");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/24.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-telep.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/23.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-vip.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/26.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-nouveaux-persos.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/31.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-pet.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/12.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-laser.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/13.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-mouche.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/25.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-mini.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/21.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-scie.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/14.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-wribit.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/22.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-barbu.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/32.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-velo.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/33.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-ultra.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/41.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-real.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/27.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-rrdb.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/swompe/pouvoirs/images/ico/11.jpg")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\icone-geant.jpg");
				fflush(stdout);
			}
			...
			if(!strcmp(tokens[1], "/client/simpleChatConfig.xml")){
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\simpleChatConfig.xml");
				fflush(stdout);
			}
			if(!strcmp(tokens[1], "/client/simpleChatConfig1.xml")){
				...
				printf("\n");
				fflush(stdout);	
				system("type sloche-data\\simpleChatConfig1.xml");
				fflush(stdout);
			}
			if(!strcmp(tokens[1], "/crossdomain.xml")){
				...
				*/
				...
				fflush(stdout);	
				system("type sloche-data\\crossdomain.xml");
				fflush(stdout);
			}
		...
		if(!strcmp(tokens[0], "POST")) {
			...
			if (!strcmp(tokens[1], "/usagers/psw.sn")) {
				...
				sprintf(tmp, "passerelle.bat psw2004.py \"%s\"", buf);
			...
			if (!strcmp(tokens[1], "/membres/liste")) {
				...
				sprintf(tmp, "passerelle.bat fiche.py \"%s\"", buf);
			...
			if(!strcmp(tokens[1], "/inscriptions")){
				...
				sprintf(tmp, "passerelle.bat get_user.py \"%s\"", buf);
				...
				sprintf(tmp, "passerelle.bat update_user.py \"%s\"", buf);
				...
				sprintf(tmp, "passerelle.bat new_user.py \"%s\"", buf);
				...
				system("type liste-pouvoirs.txt");
				printf("\n");
				fflush(stdout);
